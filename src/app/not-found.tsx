	...
	return (
		<section className="max-container !min-h-[60vh] flex justify-center items-center flex-col wrapper">
			...
			<div className="flex gap-4 mt-8">
				<Link href="/" className="text-primary ml-2 hover:bg-accent/70 transition capitalize bg-accent py-1.5 px-8 rounded-md">Home</Link>
				<Link href="/contact" className="text-primary hover:bg-accent transition hover:text-white ml-2 capitalize border py-1.5 px-8 rounded-md text-accent border-accent">Contact Me</Link>
			</div>
		</section>
	);
};
