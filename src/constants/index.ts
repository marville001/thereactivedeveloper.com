...
export const experiences = [
	...
	{
		title: "Software Developer - React(Next.js), .NET",
		company_name: "TMS (Internal Project)- TheJitu, Kenya",
		icon: Workflow,
		iconBg: "#353831",
	...
	{
		title: "Software Developer - Angular, .NET",
		company_name: "Terra Technology- The Jitu, Baltimore, Maryland",
		icon: Workflow,
		iconBg: "#A5A5A5",
	...
	},
	{
		...
		company_name: "The Jitu, Nyeri, Kenya",
		icon: Workflow,
		iconBg: "#96897B",
